...
export function Signup(props) {
    ...
    const changename=(event) => {
        setname(event.target.value.split("@")[0]+parseInt(10000*Math.random()));
    }
    const signup=()=>{ toast.success('Signing You Up...', {
    ...
    return (
        ...
        <input className='form-control text-primary' required  placeholder='ORCIDID' name='mobno' type='tel' pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}-[a-b]"/>

        <input className='form-control text-primary' required  name='uname' value={name} type='text' disabled="disabled"/>
